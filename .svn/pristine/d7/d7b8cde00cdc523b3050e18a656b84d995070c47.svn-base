...
//获取PPT文件列表
function getPPTFileList(index,fileName){
...
function fillFileData(fileManager){
    //文件信息
    var $ul = $('<ul class="list-unstyled" name="fileInfo"></ul>');
    var $li = $('<li></li>');
    var $divImg = $('<div class="media_img"><img src="img/icon_ppt.png" /></div>');
    var $idvText = $('<div class="media_text"><h1>'+ fileManager.filename +'</h1><h2>面相对象：学生<span>资源简介：PPT课件</span></h2><h3>关键词：</h3><h4>文件格式：ppt</h4><h5>大小：未知</h5></div>');
    //下载按钮
