...
/*					if(user.getCardId() != null && !user.getCardId().equals("")){
	...
	public String batchUpdate(String property,Map<String, List<String>> params){
		List<String> list = params.get("list");
		String sql = "";
		if(property.equals("0")){
			sql += " UPDATE user_table SET subscribe = '0' WHERE email in(";
	...
	/*public String queryUserByCourseId(Integer courseId){
		System.err.println("sql-------------");
		String sql2 = new SQL(){
			{
				SELECT("user_id");
