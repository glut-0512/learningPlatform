...
//获取PPT文件列表
function getPDFFileList(index,fileName){
...
function fillFileData(fileManager){
    ...
    var $idvText = $('<div class="media_text"><h1>'+ fileManager.filename +'</h1><h2>面相对象：所有人<span>资源简介：PPT课件</span></h2><h3>关键词：</h3><h4>文件格式：pdf</h4><h5>大小：未知</h5></div>');
    //下载按钮
