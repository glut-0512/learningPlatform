...
public class TextMessageSender {
	// 发件人的中文昵称
    private static final String nickname = "资源教学平台";

    // 发件人在邮箱服务器中的用户名
    private static final String username = "zhuls1993@126.com";

    // 发件人在邮箱服务器中的授权码
    private static final String password = "541000glut";
    ...
    public static MimeMessage createMessage(Session session, Email email) throws Exception{
        ...
        message.setContent(email.getContent(),"text/html;charset=gb2312");
        // 保存并生成最终的邮件内容
        message.saveChanges();
